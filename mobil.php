...
terlebih dahulu.';
    ...
    if (isset($_REQUEST['aksi'])) {
        ...
        <div class="container">
        <div class="col-md-8">
        <h3 style="margin-bottom: -20px;">Data Master Mobil</h3>
        <a href="./admin.php?hlm=mobil&aksi=add" class="btn
           btn-success btn-s pull-right">Tambah Data</a>
        <br/><hr/>
        ...
        <script type="text/javascript" language="JavaScript"> function konfirmasi(){
        tanya = confirm("Anda yakin akan menghapus user ini?"); if (tanya == true) return true;
             else return false;
        }
        </script>
...
untuk ditampilkan. <u><a href="?hlm=mobil&aksi=add">Tambah data baru</a></u> </p></center></td></tr>';
        }
        echo '
 	</tbody>
</table>
