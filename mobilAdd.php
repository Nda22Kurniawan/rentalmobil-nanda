...
<div class="col-sm-4">
<input type="text" class="form-control" id="merk" name="txtMerk" placeholder="Merk Mobil" required>
</div>
</div>
...
<div class="col-sm-2">
<input type="number" class="form-control" id="tahun" name="numTahun" placeholder="Tahun" required>
</div>
</div>
...
<div class="col-sm-3">
<input type="text" class="form-control" id="plat" name="txtPlat" placeholder="No. Plat Mobil" required>
</div>
</div>
