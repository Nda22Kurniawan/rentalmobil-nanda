...
if(empty($_SESSION['id_user'])){
 	...
 	$sql = mysqli_query($koneksi, "UPDATE mobil SET merk='$merk', tahun='$tahun',plat='$plat' WHERE id_mobil='$id_mobil'");
 	...
 	$sql = mysqli_query($koneksi, "SELECT * FROM mobil WHERE id_mobil='$id_mobil'");
...
<div class="col-sm-2">
<input type="number" class="form-control" id="tahun" value="<?php echo $row['tahun']; ?>" name="numTahun" placeholder="Tahun" required>
</div>
</div>
