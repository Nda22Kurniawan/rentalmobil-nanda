...
if(empty($_SESSION['id_user'])){
 	...
 	$sql = mysqli_query($koneksi, "INSERT INTO transaksi(no_nota, tanggal, nama_cust, no_ktp, alamat, biaya, id_user, id_mobil)
 	VALUES('$no_nota', now(), '$nama_cust', '$no_ktp', '$alamat', '$biaya', '$id_user', '$id_mobil')");
...
<div class="col-sm-3">
<input type="text" class="form-control" id="customer" name="txtCustomer" placeholder="Nama pelanggan" required>
</div>
</div>
...
<div class="col-sm-3">
<input type="number" class="form-control" id="numKTP" name="numKTP" placeholder="Isikan No. KTP" required>
</div>
</div>
...
<div class="col-sm-3">
<input type="number" class="form-control" id="numBiaya" name="numBiaya" placeholder="Isi dengan angka" required>
</div>
</div>
<div class="form-group">
