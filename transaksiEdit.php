...
if (empty($_SESSION['id_user'])) {
    ...
    if (isset($_REQUEST['submit'])) {
        ...
        $sql = mysqli_query($koneksi, "UPDATE transaksi SET nama_cust='$nama_cust', no_ktp='$no_ktp', alamat='$alamat', biaya='$biaya', id_user='$id_user', id_mobil='$id_mobil' WHERE id_transaksi='$id_transaksi'");
        ...
        while ($row = mysqli_fetch_array($sql)) {
            ...
            <form method="post" action="" class="form-horizontal" role="form">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <select name="cobMerk" class="form-control" required>
                            ...
                            <?php
                            $sql_mobil = mysqli_query($koneksi, "SELECT * FROM mobil");
                            while ($data = mysqli_fetch_array($sql_mobil)) {
                                if ($data['id_mobil'] == $row['id_mobil']) {
                                    echo "<option value='" . $data['id_mobil'] . "' selected>" . $data['merk'] . " - " . $data['tahun'] . " - " . $data['plat'] . "</option>";
                                } else {
                                    echo "<option value='" . $data['id_mobil'] . "'>" . $data['merk'] . " - " . $data['tahun'] . " - " . $data['plat'] . "</option>";
                                }
                            }
                            ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="customer" name="txtCustomer" value="<?php echo $row['nama_cust']; ?>" placeholder="Nama Customer" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="number" class="form-control" id="numKTP" name="numKTP" value="<?php echo $row['no_ktp']; ?>" placeholder="No. KTP" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="text" class="form-control" id="txtAlamat" name="txtAlamat" value="<?php echo $row['alamat']; ?>" placeholder="Alamat Customer" required>
                    </div>
                </div>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-3">
                        <input type="number" class="form-control" id="numBiaya" name="numBiaya" value="<?php echo $row['biaya']; ?>" placeholder="Biaya Sewa" required>
                    </div>
                </div>
