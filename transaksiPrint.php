...
$sql = mysqli_query($koneksi, "SELECT a.no_nota, a.tanggal, a.nama_cust, a.no_ktp, a.alamat, a.biaya, b.merk, b.plat FROM transaksi a, mobil b where a.id_mobil=b.id_mobil and a.id_transaksi='$id_transaksi'");

list($no_nota, $tanggal, $nama_cust, $no_ktp, $alamat, $biaya,
$merk, $plat) = mysqli_fetch_array($sql);

echo '
<center><h3>Rental Mobil USM</h3></center>
<hr/>
