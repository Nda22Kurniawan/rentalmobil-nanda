		...
		echo '
			...
			//skrip untuk menampilkan data dari database
		 	...
		 	if(mysqli_num_rows($sql) > 0){
				 ...
				 echo '<tr><td colspan="6"><center><p class="add">Tidak ada data untuk ditampilkan. <u><a href="?hlm=user&aksi=add">Tambah user baru</a></u> </p></center></td></tr>';
			}
			echo '
			 	</tbody>
			</table>
